...
if __name__ == "__main__":
    ...
    for n_whales in whale_values:
        iterations = list(range(1, len(all_profits[n_whales]) + 1))
        plt.plot(iterations, all_profits[n_whales], '--s', label=f'Whales = {n_whales}', linewidth=2)
