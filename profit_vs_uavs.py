...
if __name__ == "__main__":
    ...
    totalprofits_random = [0 for _ in range(len(uav_counts))]
    totalprofits_whale = [0 for _ in range(len(uav_counts))]
    totalprofits_vulture = [0 for _ in range(len(uav_counts))]
    ...
    # Save and show
    filename = "profit_vs_uavs_num_users"+str(num_users) + ".png"
