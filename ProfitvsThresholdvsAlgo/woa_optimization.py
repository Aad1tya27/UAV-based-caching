...
def woa_optimizer(fitness_func, user_requests, user_pos, uav_pos, P_u_v_k, B_u_v_k, cluster_labels, K, num_users, num_UAVs, uav_density, tau_U, max_iter=5, n_whales=30, omega=0.5):
