...
if __name__ == "__main__":
    ...
    all_profits = {}
    UAV_values = list(range(6, 15, 2))  # 6, 8, 10, 12, 14
    ...
    for num_UAVs in UAV_values:
        iterations = list(range(1, len(all_profits[num_UAVs]) + 1))
        plt.plot(iterations, all_profits[num_UAVs], '--s', label=f'UAVs = {num_UAVs}', linewidth=2)
