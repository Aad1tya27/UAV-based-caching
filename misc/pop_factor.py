...
if __name__ == "__main__":
    ...
    totalprofits_random = [0 for _ in range(len(omeg_cnt))]
    totalprofits_whale = [0 for _ in range(len(omeg_cnt))]
    totalprofits_vulture = [0 for _ in range(len(omeg_cnt))]
    ...
    # Save and show
    filename = "profit_vs_pop_factor"+str(num_users) + ".png"
