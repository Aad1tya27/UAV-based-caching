...
if __name__ == "__main__":
    ...
    for _ in range(max_iters):
        for idx, num_UAVs in enumerate(uav_counts):
            ...
            B_u_v_initial = np.empty((K, num_users, num_UAVs))
            for k in range(K):
                P_u_v_initial[k], B_u_v_initial[k] = optimize_power_allocation(user_pos, uav_pos, initial_cluster_labels[k], num_users, num_UAVs)
            ...
            totalprofit = main(q_V, q_U, user_requests, user_pos, uav_pos, P_u_v_initial, B_u_v_initial, initial_cluster_labels, K, num_users, num_UAVs, uav_density, tau_U )
            print(totalprofit)
            ...
            optimal_solution2 = woa_optimizer(fitness_func, user_requests, user_pos, uav_pos, P_u_v_initial, B_u_v_initial, initial_cluster_labels, K, num_users, num_UAVs, uav_density, tau_U)
            ...
            optimal_solution3 = avoa_optimizer(fitness_func, user_requests, user_pos, uav_pos, P_u_v_initial, B_u_v_initial, initial_cluster_labels, K, num_users, num_UAVs, uav_density, tau_U)
    ...
    results_file = "uav-vs-algo/results.txt"
    ...
    # Save and show
    filename = "uav-vs-algo/profit_vs_uavs_num_users"+str(num_users) + ".png"
