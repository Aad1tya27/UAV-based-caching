...
if __name__ == "__main__":
    ...
    all_profits = {}
    content_values = list(range(260, 321, 20))  # 260, 280, 300, 320
    ...
    for total_contents in content_values:
        iterations = list(range(1, len(all_profits[total_contents]) + 1))
        plt.plot(iterations, all_profits[total_contents], '--s', label=f'Contents = {total_contents}', linewidth=2)
