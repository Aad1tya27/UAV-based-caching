...
class Whale:
    def __init__(self, dim,M_V, seed):
...
def woa_optimizer(fitness_func, user_requests, user_pos, uav_pos, P_u_v_k, B_u_v_k, cluster_labels, K, num_users, num_UAVs, uav_density, tau_U, M_V, max_iter=30, n_whales=30, omega=0.5):
    print("Initializing Whale Optimization...")
    iterations_values = []
    
    # Initialize population
    population = [Whale(dim, M_V, i) for i in range(n_whales)]
