...
if __name__ == "__main__":
    ...
    all_profits = {}
    M_V_values = list(range(100, 125, 20))
    ...
    for M_V in M_V_values:
        iterations = list(range(1, len(all_profits[M_V]) + 1))
        plt.plot(iterations, all_profits[M_V], '--s', label=f'M_V = {M_V}', linewidth=2)

    plt.xlabel('Number of Iterations', fontsize=12)
    plt.ylabel('Total Profit', fontsize=12)
    plt.title("System Performance Comparison for Different Cache Sizes", fontsize=14)
